#!/usr/bin/env python3
# reconstruct_op.py
# usage: python3 reconstruct_op.py /path/to/simulation/data
#
...
DEFAULT_CASES_DIR = "/scratch/phong/testing_cases/v2_test/"
...
def process_case(args):
    ...
    # Skip if both 1250 and 1250.old exist (already reconstructed)
    if os.path.isdir(time_folder) and os.path.isdir(time_folder_old):
        print(f"  ~ {case_name} — {TIME} and {TIME}.old both exist, skipping")
        status["success"] = True
        return status
